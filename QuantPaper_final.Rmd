...
Figureoneword <- JSTOR_1word(multiple_archives, "commodity") #Can only get doi directly out of one word or two words function, use those articles only, supplement with other tables just for interesting things to talk about. 2wordcor and PCA doesn't give doi.
